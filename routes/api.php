...
Route::get('/cities', 'UserApiController@city');
...
Route::group(['middleware' => ['auth:api']], function () {
	...
	Route::post('/update/details','UserApiController@update_details');
	// services
	...
	Route::get('/virtual-change/{id}', 'UserApiController@virtualChangeRide');
