...
class RideController extends Controller
{
    ...
    public function confirm_ride(Request $request)
    {
        ...
        $url = "https://maps.googleapis.com/maps/api/directions/json?origin=$origin&destination=$destination&mode=driving&key=".setting('map_key', config('constants.map_key'));
        ...
        $staticmap =  "https://maps.googleapis.com/maps/api/staticmap?size=600x450&maptype=roadmap&path=enc:$polyline&$markers&key=". setting('map_key', config('constants.map_key'));
