...
class ProviderDocumentResource extends Controller
{
    ...
    public function store(Request $request, $provider)
    {
        ...
        try {
            ...
            if($request->method == "update"){
                ...
                if($ProviderFleet){
                    ...
                    return back()->with('flash_error', "O serviço não pertence a cidade de cadastro do motorista. Por favor, selecione um serviço da mesma franquia do motorista.");
                }
            }
        ...
        return back()->with('flash_success', 'Serviço atribuído com sucesso!');
    }
