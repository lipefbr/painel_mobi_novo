...
class DisputeResource extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            return redirect()->route('admin.dispute.index')->with('flash_success', trans('admin.dispute_msgs.saved'));
    ...
    public function create_dispute(Request $request)
    {
        ...
        try{
            ...
            $Dispute->fleet_id = Provider::findOrFail($request->provider_id)->fleet;
            ...
            if($request->ajax()){
                ...
                return redirect()->route('admin.userdisputes')->with('flash_success', trans('admin.dispute_msgs.saved'));
            }
        } 
