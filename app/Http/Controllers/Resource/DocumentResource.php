...
class DocumentResource extends Controller
{
    ...
    {
        $documents = Document::where('fleet_id', 0)->orderBy('created_at' , 'desc')->get();
        $fleetCities = DB::table('fleet_cities') ->join('fleets', 'fleets.city_id', '=', 'fleet_cities.city_id')->select('fleet_cities.*')->get();
        return view('admin.document.index', compact('documents', 'fleetCities'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            if ($doc->fleet_id > 0) {
                return back()->with('flash_success', trans('admin.document_msgs.document_saved'));
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->back()->with('flash_success', trans('admin.document_msgs.document_update'));    
        } 
