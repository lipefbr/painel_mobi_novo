...
class ReferralResource extends Controller
{
    ...
    public function create_referral($referral_code,$referral_data)
    {
        ...
        if(!empty($referral)){
            ...
            if(setting('referral_amount', config('constants.referral_amount')) > 0){
                ...
                if(setting('referral_count', config('constants.referral_count')) > 0 && setting('referral_count', config('constants.referral_count')) == $Referralcount) {                
                    ...
                    (new TripController)->referralCreditDebit( setting('referral_amount', config('constants.referral_amount')),$referral->id,$type);
