...
class ServiceResource extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $service->service_type_vehicle = $request->service_type_vehicle;
            $service->status = 1;
            ...
            return redirect()->route('admin.fleet.show',  $service->fleet_id )->with('flash_success', trans('admin.service_type_msgs.service_type_saved'));
        } catch (Exception $e) {
            dd("Exception", $e);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.fleet.show',  $request->fleet_id )->with('flash_success', trans('admin.service_type_msgs.service_type_update'));
        }
