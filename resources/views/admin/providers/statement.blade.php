    ...
    <div class="container-fluid">
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="box box-block bg-white tile tile-1 mb-2" style="border-top-color: #f44236 !important;">
                        <div class="t-icon right"><span class="bg-primary" style="background-color: #f44236 !important;"></span><i class="ti-bar-chart"></i></div>
                        <div class="t-content">
                            <h6 class="text-uppercase mb-1">@lang('admin.dashboard.all_kms')</h6>
                            <h1 class="mb-1">{{$all_kms}}</h1>
                            <i class="fa fa-caret-down text-danger mr-0-5"></i><span>Total de Km rodado</span>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-bordered dataTable" id="table-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-primary" href="{{route('admin.requests.show',$ride->id)}}"><span class="underline">Ver detalhes</span></a>									
                                        </td>
                                    </tr>
                                    @endforeach
