                    ...
                    <form class="form-horizontal" action="{{route('admin.service.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <label for="image" class="col-sm-2 col-form-label">@lang('admin.picture')</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                ...
                                <label for="marker" class="col-sm-2 col-form-label">@lang('admin.service.Service_marker_Image')</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <label for="minute" class="col-sm-2 col-form-label">@lang('admin.service.unit_time') ({{ currency() }})</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                   <select name="service_type_vehicle" class="form-control" required>
                                        <option value="2">Selecione o Tipo de Veículo</option>
                                        @foreach(config('utils.service_type_vehicle') as $key => $vehicle)
                                        <option {{ !empty($service->service_type_vehicle) &&  $key ==$service->service_type_vehicle?'selected':'' }} value="{{ $key }}">{{ $vehicle }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary">@lang('admin.service.Update_Service_Type')</button>
                            </div>
                        </div>
                    </form>
                </div>
